...
static const uint8_t FontLookup [][5] =
{
    ...
    { 0x00, 0x00, 0x36, 0x00, 0x00 },   // Â¦
    { 0x0e, 0x51, 0x31, 0x11, 0x08 },   // Ã‡
    { 0x3c, 0x41, 0x40, 0x21, 0x7c },   // Ã¼
    { 0x38, 0x54, 0x56, 0x55, 0x18 },   // Ã©
    { 0x20, 0x56, 0x55, 0x56, 0x78 },   // Ã¢
    { 0x20, 0x55, 0x54, 0x55, 0x78 },   // Ã¤
    { 0x20, 0x55, 0x56, 0x54, 0x78 },   // Ã 
    { 0x08, 0x08, 0x2a, 0x1c, 0x08 },   // Right Arrow  (chr 134)
    { 0x0e, 0x51, 0x31, 0x11, 0x08 },   // Ã§
    { 0x38, 0x56, 0x55, 0x56, 0x18 },   // Ãª
    { 0x38, 0x55, 0x54, 0x55, 0x18 },   // Ã«
    { 0x38, 0x55, 0x56, 0x54, 0x18 },   // Ã¨
    { 0x00, 0x45, 0x7c, 0x41, 0x00 },   // Ã¯
    { 0x00, 0x46, 0x7d, 0x42, 0x00 },   // Ã®
    ...
    { 0x38, 0x46, 0x45, 0x46, 0x38 },   // Ã´
    { 0x7f, 0x7f, 0x7f, 0x7f, 0x7f },   // free	(chr 148)		
    { 0x38, 0x45, 0x46, 0x44, 0x38 },   // Ã²
    { 0x3c, 0x42, 0x41, 0x22, 0x7c },   // Ã»
    { 0x3c, 0x41, 0x42, 0x20, 0x7c }    // Ã¹
};
...
void lcdInit( void )
{
    ...
    /*
        LcdBiasSystem(0x03);    //Ã�Ã†Â¼Ã¶Â»Ã¬ÂºÃ�Ã‚ÃŠ 1:48
        LcdSetVop(0x32);                //V(6.06) = 3.06 + 0.06*Vop
        LcdTempCtrl(0x00);              //ÃŽÃ‚Â¶ÃˆÃ�ÂµÃŠÃ½ 0~3
        LcdFunctionSet(ACTIVE, H_ADDR, BAS_INS);        //Â»Ã¹Â±Â¾Ã–Â¸Ã�Ã®Â¼Â¯
        LcdDispalyControl((u8)NORMAL_MODE);             //Ã†Ã•Ã�Â¨Ã„Â£ÃŠÂ½Ã�Ã”ÃŠÂ¾
        //
